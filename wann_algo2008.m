...
apl6net=newff(apl6_in,apl6_tar, [5,12,15,7] ,{'tansig','tansig','tansig','tansig','purelin'},'trainlm');
...
dpl6net=newff(dpl6_in,dpl6_tar, [5,12,15,7] ,{'tansig','tansig','tansig','tansig','purelin'},'trainlm');
...
dpl5net=newff(dpl5_in,dpl5_tar, [5,12,15,7] ,{'tansig','tansig','tansig','tansig','purelin'},'trainlm');
...
dpl4net=newff(dpl4_in,dpl4_tar, [5,12,15,7] ,{'tansig','tansig','tansig','tansig','purelin'},'trainlm');
...
dpl3net=newff(dpl3_in,dpl3_tar, [5,12,15,7] ,{'tansig','tansig','tansig','tansig','purelin'},'trainlm');
...
dpl2net=newff(dpl2_in,dpl2_tar, [5,12,15,7] ,{'tansig','tansig','tansig','tansig','purelin'},'trainlm');
...
dpl1net=newff(dpl1_in,dpl1_tar, [5,12,15,7] ,{'tansig','tansig','tansig','tansig','purelin'},'trainlm');
